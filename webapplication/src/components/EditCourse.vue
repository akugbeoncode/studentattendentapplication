                    ...
                    <div class="col-md-6 order-md-1 offset-md-3">
                        <form>
                            <div class="mb-3">
                                ...
                                <input disabled type="text" v-model="course_ref" class="form-control" placeholder="saa-cos-001" required>
                            </div>
                            ...
                            <hr class="mb-4">
                            <button  :disabled="loading" @click="updateCourseRecord" class="btn btn-primary btn-lg btn-block" type="button">
                                Update Course Record <i v-if="loading" class="fa fa-spinner fa-pulse fa-fw"></i><span v-if="loading" class="sr-only">Loading...</span>
                            </button>
                        </form>
                    </div>
                </main>
...
<script>
    ...
    export default {
        ...
        data () {
            return {
                pageHeader: "Course Manager/Edit",
                course_ref: "",
                title: "",
                code: "",
                taught_by: "",
                        ...
                        querySnapshot.forEach( doc => {
                            doc.ref.update({
                                ...
                                "taught_by": this.taught_by
                                    ...
                                    this.$router.push({
                                    name: 'view-course',
                                    params: { course_ref: this.course_ref }
                                })
                                this.loading = false
                            })
                        })
