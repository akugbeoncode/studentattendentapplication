...
public class StudentCourseClassroomAdapter extends BaseAdapter {
    private static final String TAG = "CCAdapter";
    Context context;
    int layoutRes;
    List<TimeTableInstance> timeTableList;
    ListView listView;
    List<String> classroomCourses;
    private FirebaseAuth firebaseAuth;
    private FirebaseUser firebaseUser;
    private FirebaseFirestore db;

    public StudentCourseClassroomAdapter(Context context, int layoutRes, List<TimeTableInstance> timeTableList, ListView listView) {
    ...
    public StudentCourseClassroomAdapter(Context context, int layoutRes, List<TimeTableInstance> timeTableList, ListView listView, List<String> classroomCourses) {
        this.context = context;
        this.layoutRes = layoutRes;
        this.timeTableList = timeTableList;
        this.listView = listView;
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (courseList != null) {
                                if (tti.getCourse_ref() != null && !tti.getCourse_ref().equals("")) {
                                    ...
                                    startClassButton.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            Intent intent = new Intent((StudentDashboard)context, StudentClassroom.class);
                                            intent.putExtra("CLASSROOM_REF", classroom);
                                            intent.putExtra("COURSE_REF", tti.getCourse_ref());
                                            ((StudentDashboard)context).startActivity(intent);
